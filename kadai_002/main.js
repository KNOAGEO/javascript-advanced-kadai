...
const keypresscountfield = document.getElementById('keypressCount');
const wrapDiv = document.getElementById('timeup');
...
const textLists = [
    ...
    'You cant get away from yourself by moving from one place to another'
];
...
const keyPress = e => {
    ...
    // タイプ数をカウント・算出✩
    keypresscountfield.textContent = score;
